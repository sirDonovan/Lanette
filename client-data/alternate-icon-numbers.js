exports.alternateIconNumbers = {
	// pokemon-showdown-client > play.pokemonshowdown.com > src > battle-dex-data.ts > BattlePokemonIconIndexes
	right: {
		// alt forms
		egg: 1032 + 1,
		pikachubelle: 1032 + 2,
	...
	// pokemon-showdown-client > play.pokemonshowdown.com > src > battle-dex-data.ts > BattlePokemonIconIndexesLeft
	left: {
		pikachubelle: 1404 + 0,
